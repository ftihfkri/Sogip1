        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <label htmlFor="investmentType" className="block text-sm font-medium text-gray-400 mb-2">
                  Investment Interest
                </label>
                <select
                  id="investmentType"
          ...
          >
            ...
            {[
              ...
              >
                ...
                <div className="relative bg-[#0A1628] border border-white/10 rounded-xl p-5 sm:p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-8">
          {[
            ...
            <motion.div
              ...
              className="bg-[#0A1628] border border-white/10 rounded-xl p-5 sm:p-8 hover:border-[#00D4FF]/30 transition-all duration-500"
            >
...
const MapSection = () => {
  ...
  return (
    <section ref={ref} className="py-14 sm:py-16 lg:py-20 bg-gradient-to-b from-[#0D1F36] to-[#0A1628]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
        ...
        >
          <div className="min-h-72 sm:aspect-video bg-gradient-to-br from-[#0D1F36] to-[#0A1628] flex items-center justify-center p-6">
