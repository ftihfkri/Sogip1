        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {locations.map((item, index) => (
            ...
            >
              ...
              <div className="relative bg-[#0A1628] border border-white/10 rounded-2xl p-8 h-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {incentives.map((item, index) => (
            ...
            >
              ...
              <div className="relative bg-[#0D1F36] border border-white/10 rounded-2xl p-8 h-full hover:border-[#00D4FF]/30 transition-all duration-500">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          {[
            ...
            >
              <div className="text-6xl font-bold text-white/5 group-hover:text-[#00D4FF]/10 transition-colors">
                {item.number}
              </div>
              <div>
